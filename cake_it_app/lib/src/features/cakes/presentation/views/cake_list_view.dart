...
class CakeListView extends StatelessWidget {
        ...
        body: Builder(builder: (context) {
          return RefreshIndicator(
            onRefresh: () async {
              ...
              if (bloc.state is! CakeListLoaded &&
                  bloc.state is! CakeListError) {
                return;
              }
  ...
  Widget _buildCakeList() {
    return BlocBuilder<CakeListBloc, CakeListState>(builder: (context, state) {
